...
### 8.26 DMS-Kachelansicht (DocumentTile / DocumentSidePanel)
...
- **Interaktion:** Einfachklick wählt genau ein Dokument aus und öffnet dessen Details im rechten Panel. Download, Entfernen aus der Bibliothek und endgültiges Löschen bleiben getrennte Aktionen; Entfernen aus der Bibliothek wird nur angeboten, wenn Owner-Verknüpfungen bestehen.
- **Toolbar:** Suche, serverseitige Typfilter und der Kachelgrößen-Wähler bleiben bei realistischen Dokumentmengen nutzbar. Sammlung und mehrere DMS-Tags werden serverseitig gefiltert; Kategorien existieren seit MS-80 nicht mehr.
