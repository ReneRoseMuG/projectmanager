...
- **Platzierung:** Ab `lg` sticky am Rand (`lg:sticky lg:top-0 lg:self-start`, `lg:max-h-full`), scrollt bei Bedarf in sich selbst; darunter stapeln die Spalten im Fluss. Die Hauptliste dazwischen dehnt sich (`flex-1 min-w-0`).
