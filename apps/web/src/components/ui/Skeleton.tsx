  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      {Array.from({ length: 6 }, (_, index) => (
        <div key={index} className="grid min-h-52 gap-4 rounded-lg border border-line bg-white p-5 shadow-sm">
  ...
  return (
    <div className="grid gap-3">
      {Array.from({ length: 5 }, (_, index) => (
        <div key={index} className="grid gap-3 rounded-lg border border-line bg-white p-4 shadow-sm">
      ...
      <div className="grid grid-cols-7 gap-px overflow-hidden rounded-md border border-line bg-line">
        {Array.from({ length: 35 }, (_, index) => (
          <div key={index} className="min-h-24 bg-white p-2">
            ...
            {index % 4 === 0 ? <Skeleton className="mt-4 h-5 w-full" /> : null}
          </div>
        ))}
      </div>
    </div>
