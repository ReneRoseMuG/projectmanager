...
export function PrioritySelect({ value, onChange }: PrioritySelectProps) {
  ...
  const options = entries.some((entry) => entry.key === value) ? entries : [{ id: 0, kind: "priority" as const, key: value, label: value, sortOrder: -1, isClosed: false, version: 1, createdAt: "", updatedAt: "" }, ...entries];
